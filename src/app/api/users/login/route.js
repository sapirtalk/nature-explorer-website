...
export async function POST(req) {
    ...
    const userDetails = { email: user[0].email, firstName: user[0].firstName, lastName: user[0].lastName , id: user[0]._id , role: user[0].role, registeredTours: user[0].registeredTours };
