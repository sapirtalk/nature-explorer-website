...
export default function DurationSlider({updateFilter , filter}) {
  ...
  useEffect(() => {
    ...
    const timeout = setTimeout(() => {
      updateFilter({...filter, duration: value });
    }, 2000);
  ...
  return (
    ...
    <Slider 
      ...
      formatOptions={{style: "unit", unit: "hour", maximumFractionDigits: 1}}
      tooltipValueFormatOptions={{style: "unit", unit: "hour", maximumFractionDigits: 1}}
      classNames={{
        base: "max-w-md",
