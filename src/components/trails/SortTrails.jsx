...
const SortTrails = ({ desktop, updateSort, updateOpenSort, sort, openSort }) => {
    ...
    }, [updateOpenSort, openSort]);

    return (
        <div className='sort-trails flex lg:w-full h-full lg:h-[20vh] flex-col'>
            <div className='flex flex-col h-full'>
                ...
                <div className='flex lg:grid lg:grid-cols-2 lg:gap-4 flex-row w-full justify-between my-2 items-center'>
                    ...
                    <Button size="sm" onClick={() => updateSort('averageRating')} className={`flex flex-row-reverse justify-center ${sort.by === 'averageRating' ? 'bg-slate-400' : 'bg-slate-500'} items-center text-white text-xl shadow-lg rounded-lg p-2 px-4`}>
